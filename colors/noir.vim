...
if has("gui_running") || &t_Co == 256
    hi Normal cterm=NONE ctermfg=10 ctermbg=0 gui=NONE guifg=#bcbcbc guibg=#000000
    hi Keyword cterm=NONE ctermfg=255 ctermbg=0 gui=NONE guifg=#eeeeee guibg=#000000
    ...
    hi Comment cterm=NONE ctermfg=13 ctermbg=0 gui=NONE guifg=#585858 guibg=#000000
    hi LineNr cterm=NONE ctermfg=8 ctermbg=233 gui=NONE guifg=#585858 guibg=#000000
    hi Number cterm=NONE ctermfg=196 ctermbg=0 gui=NONE guifg=#ff0000 guibg=#000000
    ...
    hi Search cterm=NONE ctermfg=0 ctermbg=2 gui=NONE guifg=#8a8a8a guibg=#303030
    hi IncSearch cterm=reverse ctermfg=10 ctermbg=0 gui=reverse guifg=#eeeeee guibg=#8a8a8a
    hi DiffChange cterm=NONE ctermfg=00 ctermbg=255 gui=NONE guifg=#d70000 guibg=#eeeeee
    ...
    hi SpellRare cterm=NONE ctermfg=124 ctermbg=0 gui=NONE guifg=#af0000 guibg=#000000
    ...
    hi SpecialKey cterm=NONE ctermfg=0 ctermbg=255 gui=NONE guifg=#000000 guibg=#eeeeee
    hi MatchParen cterm=NONE ctermfg=0 ctermbg=240 gui=NONE guifg=#000000 guibg=#585858
    hi CursorLine cterm=NONE ctermfg=NONE ctermbg=233 gui=NONE guifg=NONE guibg=#121212
    hi StatusLine cterm=bold,reverse ctermfg=245 ctermbg=0 gui=bold,reverse guifg=#8a8a8a guibg=#000000
    hi StatusLineNC cterm=reverse ctermfg=236 ctermbg=0 gui=reverse guifg=#303030 guibg=#000000
    hi Visual cterm=reverse ctermfg=10 ctermbg=0 gui=reverse guifg=#bcbcbc guibg=#000000
